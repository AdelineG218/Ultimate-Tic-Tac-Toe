...
SRC_FILES = main.cpp SmallBoard.cpp LargeBoard.cpp Board.cpp
...
# DEPENDENCIES
main.o: main.cpp SmallBoard.h LargeBoard.h Point.h Board.h
SmallBoard.o: SmallBoard.cpp SmallBoard.h Board.h
LargeBoard.o: LargeBoard.cpp LargeBoard.h Board.h Point.h